...
[23. SQL 05 **Типы данных и работа с ними**](#Учебный-модуль-SQL-05)  
[24. SQL 05 **Допкурс "SQL:практические задания"**](#Учебный-модуль-SQLpractic)  
[25. EDA 01 **Введение в EDA: алгоритмы и методы**](#Учебный-модуль-EDA-01)    
[26. EDA 02 **Математическая статистика в контексте EDA**](#Учебный-модуль-EDA-02)  
[27. EDA 03 **Проектирование признаков**](#Учебный-модуль-EDA-03)  
[28. EDA 03 **Статистические тесты**](#Учебный-модуль-EDA-04)  
[29. EDA 05 **Проектирование экспериментов**](#Учебный-модуль-EDA-05)  
...
5. Ручная генерация
6. Исключение повторяющихся данных
7. Выборка общих данных из нескольких таблиц

### Учебный модуль SQL 05
Тема модуля: **Типы данных и работа с ними**  
Задания из модуля реализованы в файле sql05.ipynb  
Опробованы и усвоены следующие приемы:
1. Типы данных в PostgreSQL
2. Основные типы дат
3. Функции и операторы с датами
4. Основные типы строковых данных
5. Функции и операторы для работы со строками  

### Дополнительный курс: практика SQL
Тема модуля: **Практика по SQL**  
Задания из модуля реализованы в файле sqlpractic.ipynb  
Опробованы и усвоены следующие приемы:
1. Библиотека
2. Кофейня
3. Грузовая компания
4. Грузовая компания: продолжение
5. Стажировка в банке
6. Библиотека: возвращение

### Учебный модуль EDA 01
Тема модуля: **Введение в EDA: алгоритмы и методы**  
Задания из модуля реализованы в файле eda01.ipynb  
Опробованы и усвоены следующие приемы:
1. Жизненный цикл ML-модели и роль EDA в машинном обучении
2. Алгоритм и методы EDA
3. EDA одной строкой кода  

### Учебный модуль EDA 02
Тема модуля: **Математическая статистика в контексте EDA**  
Задания из модуля реализованы в файле eda02.ipynb  
Опробованы и усвоены следующие приемы:
1. Описательная статистика. Меры центральной тенденции в Python
2. Корреляция
3. Корреляция Пирсона
4. Ранговые корреляции
5. Визуализация корреляций. Матрица корреляций
6. График рассения
6. Парные отношения в наборе данных  

### Учебный модуль EDA 03
Тема модуля: **Проектирование признаков**  
Задания из модуля реализованы в файле eda03.ipynb  
Опробованы и усвоены следующие приемы:
1. Создание признаков
2. Внешние источники данных
3. Работа с форматом "дата-время"
4. Кодирование признаков. Методы
5. Преобразование признаков. Нормализация. Стандартизация
6. Отбор признаков. Мультиколлинеарность.  

### Учебный модуль EDA 04
Тема модуля: **Статистические тесты**  
Задания из модуля реализованы в файле eda04.ipynb
Практическое задание реализовано в модуле hW02.ipynb  
Опробованы и усвоены следующие приемы:
1. Необходимость в статистических тестах
...
8. Статистические тесты для категориальных признаков
9. Практика. Статистические тесты в контексте EDA

### Учебный модуль EDA 05
Тема модуля: **Проектирование экспериментов**  
Задания из модуля реализованы в файле eda05.ipynb
Практическое задание реализовано в модуле hW03.ipynb  
Опробованы и усвоены следующие приемы:
1. Введение в проектирование экспериментов
2. Логирование экспериментов
3. Знакомство с Comet.ml
4. Планирование эксперимента и логирование изменений в Comet.ml
